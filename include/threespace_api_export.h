...
#define TSS_STREAMING_PACKET_SIZE 256
...
#define TSS_STREAM_DURATION_INFINITE 0xffffffff
	...
	***********************************************/
	typedef enum TSS_TYPE
	{
		...
		TSS_FIND_ALL_KNOWN = 1022,	/**< Find all serial ports that have 3-Space devices connected */
        TSS_FIND_ALL = 1023			/**< Find all serial ports including "unknown" serial ports that may have 3-Space devices connected */
	} TSS_TYPE;
